...
<schema
  ...
  <xsl:include href="../common/functions-for-xml-data.xsl"/>
  <xsl:include href="../common/functions-for-niem-data.xsl"/>
  <xsl:include href="../common/functions-for-models.xsl"/>
  ...
  <pattern>
    <rule context="*[@structures:ref]">
      <assert test="node-name(f-niem:resolve(.)) = node-name(.)"
  ...
  <pattern>
    <rule context="*[f-niem:is-target(.)
                     and (self::mm:ObjectProperty or self::mm:Class or self::mm:DataProperty or self::mm:Datatype)]">
      <let name="component-qname" value="f-model:component-get-qname(.)"/>
  ...
  <pattern>
    <rule context="*[f-model:is-component(.) and f-niem:is-target(.) and mm:DefinitionText]">
      <assert test="f-niem:resolve(mm:Namespace)/mm:DefinitionText"
              >An object property that is a definition must have a namespace that is a definition.</assert>
    </rule>
    <rule context="*[f-model:is-component(.) and f-niem:is-target(.) and empty(mm:DefinitionText)]">
      <assert test="empty(f-niem:resolve(mm:Namespace)/mm:DefinitionText)"
              >An object property that is a reference must have a namespace that is a reference.</assert>
    </rule>
  </pattern>

  <pattern>
    <rule context="mm:ObjectProperty[f-niem:is-target(.) and mm:DefinitionText]">
      <assert test="true()">OK</assert>
    </rule>
    <rule context="mm:ObjectProperty[f-niem:is-target(.) and empty(mm:DefinitionText)]">
  ...
  <pattern>
    <rule context="mm:ObjectProperty[f-niem:is-target(.) and mm:DefinitionText and empty(mm:Class)]">
  ...
  <pattern>
    <rule context="mm:Class[f-niem:is-target(.) and f-model:component-get-qname(.) = xs:QName('structures:ObjectType')]">
    ...
    <rule context="mm:Class[f-niem:is-target(.) and mm:DefinitionText]">
      <assert test="mm:ExtensionOf"
              >A class that is a definition must have mm:ExtensionOf</assert>
    </rule>
    <rule context="mm:Class[f-niem:is-target(.) and empty(mm:DefinitionText)]">
  ...
  <pattern>
    <rule context="mm:Class[f-model:component-get-qname(.) = xs:QName('structures:ObjectType')]">
      <assert test="true()">OK</assert>
    </rule>
    <rule context="mm:Class[mm:ExtensionOf/mm:Class and f-model:component-get-qname(mm:Extension/mm:Class) = 'HasValue']">
      <assert test="empty(mm:HasObjectProperty)"
              >A class that extends a class with content style HasValue must not have mm:HasObjectProperty.</assert>
    </rule>
    <rule context="mm:Class[mm:ExtensionOf/mm:Class and f-model:component-get-qname(mm:Extension/mm:Class) = 'HasObjectProperty']">
      <assert test="empty(mm:HasValue)"
    ...
    <rule context="mm:Class[mm:ExtensionOf/mm:Class]">
      <assert test="true()"
              >Strange result from f-model:component-get-qname(): &quot;<value-of select="f-model:component-get-qname(mm:Extension/mm:Class)"/>&quot;.</assert>
    </rule>
  </pattern>

  <pattern>
    <rule context="mm:DataProperty[f-niem:is-target(.) and mm:DefinitionText]">
      <assert test="mm:Datatype"
              >A DataProperty that is a definition must have mm:Datatype.</assert>
    </rule>
    <rule context="mm:DataProperty[f-niem:is-target(.) and empty(mm:DefinitionText)]">
  ...
  <pattern>
    <rule context="mm:Datatype[f-niem:is-target(.) and mm:DefinitionText]">
    ...
    <rule context="mm:Datatype[f-niem:is-target(.) and empty(mm:DefinitionText)]">
      <assert test="empty(mm:Datatype)"
